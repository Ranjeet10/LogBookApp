	...
	<div>
		<div id="addJobDetailsDiv" class="container">
			<div class="row">
				...
				style="color: blue;">Job Log Book</a></div>
				<div><h4 style="margin: 0;">Add a machine</h4></div>
					...
					<table>
						...
						<tr>
						<td>Shift:</td>
						<td><input style="margin-right:5px;" type="radio" name="shift" value="General Shift" CHECKED /><span style="padding-right:5px;">General Shift</span>
						<input style="margin-right:5px;" type="radio" name="shift" value="Second Shift" /><span style="padding-right:5px;">Second Shift</span>
						<input style="margin-right:5px;" type="radio" name="shift" value="Night Shift" /><span style="padding-right:5px;">Night Shift</span>
						<input style="margin-right:5px;" type="radio" name="shift" value="OT" /><span style="padding-right:5px;">OT</span></td>
						</tr>
						<tr>
						<td>Total Working Hours (Specify in hrs:)</td>
						<td><input id="total_working_hours" type="text" name="total_working_hours" /></td>
						</tr>
						<!-- <tr>
						...
						<tr>
							...
							<td>
							<button type="button" class="btn btn-xs btn-success btn-block" style="width: 77px;" onclick="window.location.href='/DeliveryManagement'">Cancel</button></td>
						</tr>
					</table>
			</div>
			<div style="color: green;margin-left: 6%;margin-bottom: 10px;margin-top: 10px;" id="successMsg"></div>
